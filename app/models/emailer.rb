class Emailer < ActionMailer::Base
   ...
   def signup_notification(recipient, recipient_name, subject, title, formal_name, informal_name, encoded_url, sent_at = Time.now)
      @subject = subject
      @recipients = recipient
      @from = 'team@stanfordpathways.com'
	...
	def signup_pending(recipient, recipient_name, subject, title, formal_name, informal_name, bcc, sent_at = Time.now)
      @subject = subject
      @recipients = recipient
      @from = 'team@stanfordpathways.com'
	  @bcc = bcc
